...
//				System.out.println("K"+k.id+" O"+o.id+" EU: "+expectedUtilities.get(o)+" Gamma'"+gammaprime.toString()+" : Average: "+Average(gammaprime));
...
//			System.out.println("O"+o.id+" Cover all:"+coverAll+ " EU:"+expectedUtilities.get(o));

			
			if(coverAll && expectedUtilities.get(o) < minUtilitySet){
//				System.out.println("O"+o.id+" Min Utility Set: "+minUtilitySet+" EU:"+expectedUtilities.get(o));
...
//		System.out.println("O"+oCover.id+" Min Utility Set: "+minUtilitySet);
		...
		//To return a strategy we should assign all other systems such that EU(sigma_k,tf) < EU(sigma_k,tf)
		//each k not in gamma, should be assigned an observable such that it's value is less than the observable used for gamma
		
		for(Systems k : game.machines){
			
			if(!gamma.contains(k)){
				for(ObservableConfiguration o : game.obs){
//					System.out.println("K"+k.id+" O"+o.id+" Min Util: "+minUtilitySet);
					
					if(o.configs.contains(k.f)){
//						System.out.println("O"+o.id+" Min Util: "+minUtilitySet);
